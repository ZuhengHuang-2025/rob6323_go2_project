...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        # Gravity vector should be [0, 0, -1]. Projected gravity is in body frame.
        ...
        rewards = {
            ...
            # --- NEW REWARDS ADDED TO DICTIONARY ---
